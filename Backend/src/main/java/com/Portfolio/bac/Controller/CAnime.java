 ...
 */
package com.Portfolio.bac.Controller;

import com.Portfolio.bac.Dto.dtoAnime;
import com.Portfolio.bac.Entity.Anime;
import com.Portfolio.bac.Security.Controller.Mensaje;
import com.Portfolio.bac.Service.SAnime;
...
public ResponseEntity<?> getById(@PathVariable("id") int id) {
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) {
        ...
        sAnime.delete(id);
        return new ResponseEntity(new Mensaje("Anime eliminado"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoAnime dtoanime){
        ...
        sAnime.save(anime);
        return new ResponseEntity(new Mensaje("Anime actualizado"), HttpStatus.OK);
